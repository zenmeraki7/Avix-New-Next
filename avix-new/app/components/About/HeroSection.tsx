...
const HeroSection = () => {
  ...
  return (
    <section className={`${styles.heroSection} avix-hero-bg`}>
      <div className={styles.heroContainer}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Since 2017, we&apos;ve been your trusted partner in achieving
            financial success and security through innovative, transparent, and
          ...
          <div className={styles.achievementsGrid}>
            {achievements.map((achievement, index) => (
              <div
                key={index}
                className={`${styles.achievementItem} avix-animate-float`}
      ...
      <div
        className={`${styles.decorativeElement2} avix-animate-float`}
