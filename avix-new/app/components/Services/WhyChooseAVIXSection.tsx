...
import styles from "../../../src/styles/services/WhyChooseAVIXSection.module.css";
...
const WhyChooseAVIXSection = () => {
  const benefits = useMemo(
    () => [
      {
        text: "Expert financial advisors with 8+ years industry experience",
        icon: Award,
      },
      { text: "Quick processing and approval times (24-48 hours)", icon: Zap },
      {
        text: "Competitive rates and completely transparent pricing",
        icon: Percent,
      },
      {
        text: "End-to-end service support throughout the process",
        icon: Users,
      },
      {
        text: "Digital convenience combined with personalized offline assistance",
        icon: Sparkles,
      },
      {
        text: "Full regulatory compliance and advanced data security",
        icon: Shield,
      },
    ],
    []
        ...
        <div className={styles.whyChooseGrid}>
          <div className={styles.whyChooseContent}>
            ...
            <p className={styles.whyChooseDescription}>
              Experience the difference of working with certified financial
              professionals who prioritize your success and financial
              well-being.
            </p>
            <div className={styles.benefitsGrid}>
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className={`${styles.benefitItem} avix-shadow-soft hover:avix-shadow-elegant avix-animate-pulse-soft`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div
                    className={`${styles.benefitIcon} avix-gradient-primary`}
                  >
          ...
          <Card
            className={`${styles.contactCard} avix-gradient-primary avix-shadow-elegant avix-animate-float`}
          >
