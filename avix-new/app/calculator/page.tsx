...
import { Calculator, PiggyBank, Home, Briefcase, Phone, Download, Share2 } from 'lucide-react';
...
const EMICalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="py-16 text-white" style={{backgroundColor: '#1A004D'}}>    
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Different loan types have different interest rate ranges</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-purple-900 mb-4">EMI Calculator</h2>
            <p className="text-gray-600">Calculate your Equated Monthly Installment (EMI) for loans with our easy-to-use calculator.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-purple-900">Loan Details</h3>
              </div>
              <p className="text-gray-600 mb-8">Adjust the sliders to calculate your EMI</p>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-purple-700 font-bold text-lg">₹{loanAmount.toLocaleString('en-IN')}</span>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #5B2C87 0%, #5B2C87 ${((loanAmount - 100000) / (10000000 - 100000)) * 100}%, #e5d3ff ${((loanAmount - 100000) / (10000000 - 100000)) * 100}%, #e5d3ff 100%)`
                      }}
                    />
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <label className="text-gray-700 font-medium">Interest Rate (per annum)</label>
                    <span className="text-purple-700 font-bold text-lg">{interestRate}%</span>
                  </div>
                  <div className="relative">
                    <input
                      type="range"
                      ...
                      className="w-full h-3 bg-purple-200 rounded-lg appearance-none slider"
                      style={{
                        background: `linear-gradient(to right, #5B2C87 0%, #5B2C87 ${((interestRate - 1) / (30 - 1)) * 100}%, #e5d3ff ${((interestRate - 1) / (30 - 1)) * 100}%, #e5d3ff 100%)`
                      }}
                    />
                    <div className="flex justify-between text-sm text-gray-500 mt-2">
                      <span>1%</span>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-3 bg-purple-200 rounded-lg appearance-none slider"
                      style={{
                        background: `linear-gradient(to right, #5B2C87 0%, #5B2C87 ${((loanTenure - 6) / (360 - 6)) * 100}%, #e5d3ff ${((loanTenure - 6) / (360 - 6)) * 100}%, #e5d3ff 100%)`
                      }}
                    />
                    <div className="flex justify-between text-sm text-gray-500 mt-2">
                      <span>6 months</span>
            ...
            <div className="bg-gradient-to-b from-[#2b0052] to-[#2b0052] text-white p-8 rounded-lg" >
             <div className="text-center mb-8">
              ...
              <div className="text-center mb-8">
                <div className="text-5xl font-bold mb-2">₹{emi.toLocaleString('en-IN')}</div>
                <div className="text-purple-200">Monthly EMI</div>
              </div>

              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="p-4 rounded-lg text-center" style={{background: 'rgba(139, 69, 164, 0.4)'}}>
                  <div className="text-2xl font-bold">₹{totalInterest.toLocaleString('en-IN')}</div>
              ...
              <button className="w-full bg-purple-800 hover:bg-purple-900 py-3 px-4 rounded-lg transition-colors">
                Apply for This Loan
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-bold text-purple-900 mb-6">EMI Calculation Tips</h3>
            ...
            <div className="bg-gradient-to-b from-[#2b0052] to-[#2b0052] text-white p-8 rounded-lg">
              <h4 className="text-2xl font-bold mb-4">Need Help With Your Calculation?</h4>
              ...
              <div className="space-y-3">
                ...
                <button className="w-full bg-purple-800 text-white py-3 px-4 rounded-lg font-medium hover:bg-purple-900 transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-purple-900 mb-4">Understanding EMI Calculation</h2>
            <p className="text-xl text-gray-600">Learn how your monthly installment is calculated</p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg shadow-md p-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-purple-900 mb-4">EMI Formula</h3>
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  <div className="text-4xl font-bold text-purple-600 mb-2">P</div>
                  <div className="font-semibold text-purple-900 mb-2">Principal Amount</div>
                  <div className="text-sm text-gray-600">The loan amount you borrow</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-purple-600 mb-2">R</div>
                  <div className="font-semibold text-purple-900 mb-2">Monthly Interest Rate</div>
                  <div className="text-sm text-gray-600">Annual rate divided by 12 months</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-purple-600 mb-2">N</div>
                  <div className="font-semibold text-purple-900 mb-2">Number of Months</div>
                  <div className="text-sm text-gray-600">Total loan tenure in months</div>
                </div>
              </div>

              <div className="mt-8 p-6 bg-purple-50 rounded-lg">
                <h4 className="font-semibold text-purple-900 mb-3">Example Calculation:</h4>
